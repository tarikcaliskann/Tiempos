...
export const en = {
  ...
  sessionPreDock: {
    ...
    subtitle: "Your session is in about 10 minutes.",
    modalTitle: "Session attendance",
    modalDescription:
      "Confirm or decline before the session. When both confirm, time credits are finalized; if both decline or answers conflict, the booking is cancelled.",
    closePanel: "Minimize",
    expandDock: "Open session confirmation",
    minimizedTabLabel: "Session",
    you: "You",
    peer: "Other participant",
    bothPartiesStatus: "Everyone’s response",
    statusPending: "Awaiting response",
    statusConfirmed: "Accepted",
    statusDeclined: "Declined",
    yourResponse: "Your response",
    peerResponse: "Other participant",
    youStatusConfirmed: "You accepted",
    youStatusDeclined: "You declined",
    youStatusPending: "You have not responded yet",
    peerStatusConfirmed: "Accepted",
    peerStatusDeclined: "Declined",
    peerStatusPending: "Awaiting response",
    peerDeclinedChoose: "The other participant declined. Please accept or decline.",
    confirm: "Accept",
    decline: "Decline",
    submitting: "Saving…",
    toastNew: "Session confirmation required",
    toastBothReady:
      "Both parties accepted. The timer starts when the lesson begins; credits settle at the end or when a problem is reported.",
    toastBothConfirmed:
      "Session completed; time credits have been transferred.",
    toastPartialSettled:
      "Problem reported. Credits were transferred for elapsed time only; the remainder was refunded.",
    toastBothDeclined:
      "Both parties declined. The booking was cancelled and held credits were refunded.",
    toastCancelledConflict:
      "Responses did not match. The booking was cancelled and held credits were refunded.",
    toastYouConfirmed: "Saved: you will attend.",
    toastYouDeclined: "Saved: you will not attend.",
    openMessages: "Open messages",
    error: "Something went wrong. Try again.",
    waitingPeerAfterYouConfirmed: "You confirmed. Waiting for the other participant.",
    youDeclinedHint: "You declined. The other participant can still respond; the booking may be cancelled if answers don’t match.",
    countdownToStart: "Time until lesson",
    countdownToEnd: "Time remaining",
    liveSessionHint:
      "Lesson in progress. Report a problem below; only elapsed time will be transferred.",
    reportProblem: "Report a problem",
    reportProblemPlaceholder: "e.g. instructor left, connection lost…",
    reportProblemSubmit: "Submit and stop session",
    reportProblemSubmitting: "Sending…",
    feedbackTitle: "Share your experience",
    feedbackSubtitleCompleted: "Session ended — rate the other participant.",
    feedbackSubtitlePartial: "Session ended early — rate based on the time that elapsed.",
    feedbackSubtitleCancelled: "Session was cancelled or ended early.",
    feedbackRateLabel: "Your rating",
    feedbackCommentLabel: "Comment (optional)",
    feedbackCommentPlaceholder: "Briefly describe your experience…",
    feedbackSubmit: "Submit review",
    feedbackSubmitting: "Saving…",
    feedbackSelectStars: "Please select 1–5 stars",
    feedbackThanks: "Thank you! Your review is on their profile.",
    feedbackViewProfile: "View profile",
    feedbackSettledLine: "{{minutes}} min transferred (booked {{booked}} min)",
    howWasItTitle: "How was it?",
    howWasItSubtitle: "Rate in one tap — comment is optional.",
    addOptionalComment: "Add optional comment",
    skipOptionalComment: "Submit without comment",
    cancelSurveyTitle: "Why was it cancelled?",
    cancelSurveySubtitle: "Not shown on profiles — used only to improve the service.",
    cancelReasonSchedule: "My schedule changed",
    cancelReasonNotNeeded: "I can’t attend / no longer needed",
    cancelReasonOther: "Other",
    cancelSurveyNoteLabel: "Short note (optional)",
    cancelSurveySubmit: "Submit",
    cancelSurveyThanks: "Thanks for your feedback.",
    cancelSurveySelectReason: "Please select a reason",
  },
};
