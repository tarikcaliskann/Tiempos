...
export const tr: Translation = {
  ...
  sessionPreDock: {
    title: "Seans onayı",
    subtitle: "Seansınıza yaklaşık 10 dakika kaldı.",
    modalTitle: "Seansa katılım",
    modalDescription:
      "Seans öncesinde katılıp katılmayacağınızı belirtin. İkiniz de onaylarsanız saat aktarımı tamamlanır; ikiniz de reddeder veya yanıtlar çelişirse rezervasyon iptal edilir.",
    closePanel: "Küçült",
    expandDock: "Seans onayını aç",
    minimizedTabLabel: "Seans",
    you: "Siz",
    peer: "Karşı taraf",
    bothPartiesStatus: "Tarafların yanıtı",
    statusPending: "Yanıt bekleniyor",
    statusConfirmed: "Kabul",
    statusDeclined: "Red",
    yourResponse: "Sizin yanıtınız",
    peerResponse: "Karşı taraf",
    youStatusConfirmed: "Kabul ettiniz",
    youStatusDeclined: "Reddettiniz",
    youStatusPending: "Henüz yanıt vermediniz",
    peerStatusConfirmed: "Kabul etti",
    peerStatusDeclined: "Reddetti",
    peerStatusPending: "Yanıt bekleniyor",
    peerDeclinedChoose: "Karşı taraf katılmayacağını bildirdi. Siz de onaylayın veya reddedin.",
    confirm: "Kabul et",
    decline: "Reddet",
    submitting: "Kaydediliyor…",
    toastNew: "Seans onayı gerekli",
    toastBothReady:
      "Her iki taraf onayladı. Ders başlayınca süre işleyecek; aktarım ders sonunda veya sorun bildiriminde yapılır.",
    toastBothConfirmed:
      "Seans tamamlandı; saat aktarımı yapıldı.",
    toastPartialSettled:
      "Sorun bildirildi. Geçen süre kadar saat aktarıldı, kalan askı iade edildi.",
    toastBothDeclined:
      "Her iki taraf reddetti. Rezervasyon iptal edildi; saat iade edildi.",
    toastCancelledConflict:
      "Yanıtlar uyuşmadı. Rezervasyon iptal edildi; askıdaki saat iade edildi.",
    toastYouConfirmed: "Yanıtınız kaydedildi: katılacaksınız.",
    toastYouDeclined: "Yanıtınız kaydedildi: katılmayacaksınız.",
    openMessages: "Mesajlara git",
    error: "Bir şeyler ters gitti. Tekrar deneyin.",
    waitingPeerAfterYouConfirmed: "Onayınız alındı. Karşı tarafın yanıtı bekleniyor.",
    youDeclinedHint:
      "Katılmayacağınızı bildirdiniz. Karşı taraf yanıt verebilir; yanıtlar uyuşmazsa rezervasyon iptal edilir.",
    countdownToStart: "Derse kalan süre",
    countdownToEnd: "Ders bitimine kalan",
    liveSessionHint: "Ders devam ediyor. Sorun varsa aşağıdan bildirin; yalnızca o ana kadar geçen süre aktarılır.",
    reportProblem: "Sorun bildir",
    reportProblemPlaceholder: "Örn. hoca gitti, bağlantı koptu…",
    reportProblemSubmit: "Gönder ve dersi durdur",
    reportProblemSubmitting: "Gönderiliyor…",
    feedbackTitle: "Deneyiminizi paylaşın",
    feedbackSubtitleCompleted: "Seans bitti — karşı tarafı değerlendirin.",
    feedbackSubtitlePartial: "Seans erken sona erdi — geçen süre için değerlendirin.",
    feedbackSubtitleCancelled: "Oturum iptal / kısmi tamamlandı.",
    feedbackRateLabel: "Puanınız",
    feedbackCommentLabel: "Yorum (isteğe bağlı)",
    feedbackCommentPlaceholder: "Deneyiminizi kısaca yazın…",
    feedbackSubmit: "Değerlendirmeyi gönder",
    feedbackSubmitting: "Kaydediliyor…",
    feedbackSelectStars: "Lütfen 1–5 yıldız seçin",
    feedbackThanks: "Teşekkürler! Değerlendirmeniz profile işlendi.",
    feedbackViewProfile: "Profili gör",
    feedbackSettledLine: "{{minutes}} dk aktarıldı (rezervasyon {{booked}} dk)",
    howWasItTitle: "Nasıldı?",
    howWasItSubtitle: "Tek dokunuşla puanlayın — yorum isteğe bağlı.",
    addOptionalComment: "İsteğe bağlı yorum ekle",
    skipOptionalComment: "Yorumsuz gönder",
    cancelSurveyTitle: "Neden iptal?",
    cancelSurveySubtitle: "Yanıtınız profile yansımaz; yalnızca hizmeti iyileştirmek için kullanılır.",
    cancelReasonSchedule: "Programım değişti",
    cancelReasonNotNeeded: "Artık katılamıyorum / gerek kalmadı",
    cancelReasonOther: "Diğer",
    cancelSurveyNoteLabel: "Kısa not (isteğe bağlı)",
    cancelSurveySubmit: "Gönder",
    cancelSurveyThanks: "Geri bildiriminiz için teşekkürler.",
    cancelSurveySelectReason: "Lütfen bir neden seçin",
  },
};
